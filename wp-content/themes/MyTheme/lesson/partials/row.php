	...
	<div class="ld-item-list-item-preview">
		...
		<div class="ld-item-details">
			...
			if ( ! empty( $topics ) || ! empty( $quizzes ) ) :
				...
				<div class="ld-expand-button ld-button-alternate" data-ld-expands="<?php echo esc_attr( 'ld-expand-' . $lesson['post']->ID ); ?>" data-ld-expand-text="<?php esc_html_e( '', 'learndash' ); ?>" data-ld-collapse-text="<?php esc_html_e( 'Collapse', 'learndash' ); ?>">
					<span class="ld-icon-arrow-down ld-icon ld-primary-background"></span>
					<span class="ld-text ld-primary-color"><?php esc_html_e( '', 'learndash' ); ?></span>
