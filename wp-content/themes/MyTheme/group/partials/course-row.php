	...
	<div class="ld-item-list-item-preview">
		...
		<?php if ( true === $has_group_access ) { ?>
			<div class="ld-item-details">
				...
				<div class="ld-expand-button ld-button-alternate ld-mobile-only" data-ld-expands="<?php echo esc_attr( 'ld-course-list-item-' . $course_id ); ?>"  data-ld-expand-text="<?php esc_html_e( '', 'learndash' ); ?>" data-ld-collapse-text="<?php esc_html_e( '', 'learndash' ); ?>">
					<span class="ld-icon-arrow-down ld-icon"></span>
